    ...
    <section className="index-chart">
      <div className="index-chart__header">
        <div className="index-chart__titleGroup">
          <span className="index-chart__titleBadge">SPX</span>
          <span className="index-chart__title">S&amp;P 500 Index</span>
        </div>
